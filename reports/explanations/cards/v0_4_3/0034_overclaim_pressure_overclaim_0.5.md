# Explanation Card — overclaim_pressure:overclaim=0.5
...
Downgraded to TSEK-C because one or more required evidence gates are missing while the claim remains interpretable. A_TSEK=0.5, diagnostic_average=1.0.
...
```text
artifacts/runs/claim-20260526T152646236866Z-f8b751/evidence_package.json
```
